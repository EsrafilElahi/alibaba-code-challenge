...
const CountryDetail = ({ country }) => {
  ...
  return (
    <div className={`w-full h-full !text-xl px-20 ${handleDarkModeClassName}`}>
      <div className='flex py-20'>
        <div className='flex justify-center items-center shadow-[0px_1px_10px_-3px] py-2 px-9 cursor-pointer rounded-md gap-2' onClick={() => router.back()}>
          <BsArrowLeft />
          <span>Back</span>
        </div>
      </div>
